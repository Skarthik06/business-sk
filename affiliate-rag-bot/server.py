...
async def cuelinks_generate(count: int = Query(default=8, ge=2, le=10,
                            ...
                            merchant: Optional[str] = Query(default=None,
                                               description="Generate deals for THIS specific store only (e.g. 'Nykaa'). Empty = mixed live deals preferring your active markets."),
                            categories: Optional[str] = Query(default=None,
                                               description="Comma-separated category names to focus on.")) -> dict:
